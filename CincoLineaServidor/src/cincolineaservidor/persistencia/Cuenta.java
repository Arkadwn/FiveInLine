...
@NamedQueries({
    ...
    @NamedQuery(name = "Cuenta.findByImagen", query = "SELECT c FROM Cuenta c WHERE c.imagen = :imagen")})
public class Cuenta implements Serializable {
    ...
    public String toString() {
        return "cincolineaservidor.persistencia.Cuenta[ nombreUsuario=" + nombreUsuario + " ]";
    }
